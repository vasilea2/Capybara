...
function HandleCapybara(message) {
  return new Promise((resolve) => {
    if (
      message.content.toLowerCase() === "capybara help" ||
      ...
      result +=
        "- type 'capybara -n <number from list>' to get that capybara\n";
      result += "- type 'capybara' to get a random capybara\n\n";
      result += "Enjoy capybaras!\n";
      resolve([result, ""]);
    } else if (
      message.content.toLowerCase() === "capybara list" ||
      ...
      message.content.toLowerCase().includes("capybara -n") ||
      ...
      message.content.toLowerCase() === "capybara" ||
